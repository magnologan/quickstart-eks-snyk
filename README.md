...
This is a preview release and not intended for production use.
...
For general EKS troubleshooting steps see the EKS Quick Start documentation(link). 
For Snyk specific troubleshooting see Snyk troubleshooting documentation(link).
